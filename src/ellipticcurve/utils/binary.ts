...
export function hexFromBinary(data: string | Buffer): string {
...
export function binaryFromHex(data: string): Buffer {
...
export function numberFromString(string: string): bigInt.BigInteger {
...
export function numberFromHex(string: string): bigInt.BigInteger {
  return bigInt(string, 16);
}

export function stringFromNumber(
